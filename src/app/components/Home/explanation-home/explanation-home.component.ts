...
@Component({
  selector: 'app-explanation-home',
  templateUrl: './explanation-home.component.html',
  styleUrls: ['./explanation-home.component.css']
})
export class ExplanationHomeComponent implements OnInit {
