...
@Component({
  selector: 'app-explanation-must-have-list',
  templateUrl: './explanation-must-have-list.component.html',
  styleUrls: ['./explanation-must-have-list.component.css']
})
export class ExplanationMustHaveListComponent implements OnInit {
